...
<fieldset>
    ...
    <ul>
        <li><p><?=__("Aficionados que visitan zonas que no conocen pueden encontrar en los anuarios información práctica para sus viajes ornitológicos. También las empresas que organizan estos viajes.");?></p></li>
        <li><p><?=__("Científicos que planifican sesudos trabajos de investigación encontrarán en los anuarios un volumen de información que difícilmente podría pagarse a través de las escasas y mal dotadas instituciones científicas de nuestro país.");?></p></li>
        <li><p><?=__("Consultores que realizan estudios de impacto ambiental para cualquier proyecto que vaya a desarrollarse en el medio natural.");?></p></li>
        <li><p><?=__("Gestores que deben tomar decisiones importantes para la conservación de especies y ecosistemas.");?></p></li>
    </ul>
