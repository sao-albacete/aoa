    ...
    <fieldset>
        ...
        <div class="row">
            ...
            <div class="span6">
                ...
                <p><span class='label <?=$this->Especie->obtenerEtiquetaProteccionClmPorCodigo($cita['Especie']['ProteccionClm']['codigo'])?>'><?=$cita['Especie']['ProteccionClm']['nombre']?></span><?=__(" en ")?><b><?=__("Castilla - La Mancha")?></b></p>
