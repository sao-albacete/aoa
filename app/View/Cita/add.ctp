...
<div id="divNuevaCita">
	<fieldset>
		...
		<form id="frmNuevaCita" class="form-horizontal" method="post"
					...
					<div style="margin-top: 5px;">
						...
						<a href="#modalSeleccioanrLugar" role="button"
						   ...
						   id="btnSeleccionarLugar"><i
								class="icon-zoom-in"></i> <?php echo __("Seleccionar desde tabla"); ?>
						</a>
			...
			<div class="control-group">
				<label class="control-label" for="datosReproduccion"> <?php echo __("Datos reproducción"); ?>
					(*) </label>
                    ...
                    <span class="btn btn-file">
                        ...
                        <input type="file" id="imagen" name="imagen"/>
							...
							<a href="#" class="btn fileupload-exists"
							   data-dismiss="fileupload"><?php echo __("Borrar"); ?></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="control-group">
				<div class="controls text-center">
					<a id="btnGuardar" class="btn btn-success btn-large"><i
							class="icon-ok"></i> <?php echo __("Guardar"); ?></a>
				</div>
			</div>
		</form>
