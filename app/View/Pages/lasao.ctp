...
<fieldset>
    ...
    <div class="row-fluid">
        ...
        <div class="span8">
            ...
            <ul>
                <li><?=__("Realización de estudios sobre la distribución y ecología de las aves de Albacete, con la organización y participación en censos de aves provinciales y censos nacionales.");?></li>
                <li><?=__("Jornadas y Campañas de anillamiento científico de aves a nivel local y nacional, a través de los anilladores de la SAO, pertenecientes al Grupo Manchego de Anillamiento.");?></li>
                <li><?=__("Divulgación del conocimiento de las aves con actividades educativas celebrando el día mundial de las aves o de los humedales,  realizando exposiciones, etc.");?></li>
                <li><?=__("Recopilación de datos sobre aves poco frecuentes, accidentadas, nidos, mortandad de aves, etc.");?></li>
                <li><?=__("Publicación de un boletín de contacto entre los socios, de la revista “La Calandria” y de anuarios ornitológicos de la provincia de Albacete.");?></li>
                <li><?=__("Denuncia de atentados contra las aves y sus hábitats.");?></li>
                <li><?=__("Participación activa  en los procesos de evaluación de impacto ambiental. ");?></li>
                <li><?=__("Organización de excursiones, proyectos, proyección de diapositivas, charlas ornitológicas, cursos de ornitología, identificación de aves y anillamiento, etc.");?></li>
            </ul>
