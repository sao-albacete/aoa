		...
		foreach ($citas as $cita) {
			...
			$observation = [
				...
				'location' => [
					...
					'comarca' => $this->Comarca->obtenerNombrePorId($cita['Lugar']['comarca_id']),
				],
				'watcher' => [
				...
				'in-weird-habitat' => $cita['Cita']['indHabitatRaro'],
				'breeding-in-weird-habitat' => $cita['Cita']['indCriaHabitatRaro'],
				'injured' => $cita['Cita']['indHerido'],
				'weird-behaviour-or-morphology' => $cita['Cita']['indComportamiento'],
