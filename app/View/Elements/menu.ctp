		...
		<div class="container">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
					...
					<!-- Inicio -->
					<li class="<?= $inicio ?>"><a href="/"><i class="icon-home"></i>&nbsp;&nbsp;<?= __("Inicio") ?></a>
					</li>
					...
					<!-- Citas -->
					<li class="<?= $citas ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-eye-open"></i>&nbsp;&nbsp;<?= __("Citas") ?>
							<b class="caret"></b> </a>
						<ul class="dropdown-menu">
							...
							<li><a href="/cita/add_multiple/"><i
										class="icon-list"></i>&nbsp;<?= __("Nuevas citas múltiples") ?></a></li>
						</ul>
					...
					<li class="<?= $especies ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><img src="/img/icons/bird.png"
																					   width="20px">&nbsp;&nbsp;<?= __("Especies") ?>
							<b class="caret"></b> </a>
						<ul class="dropdown-menu">
							<!-- Lista de aves de Albacete -->
							<li><a href="/especie/lista_ab/"><i
										class="icon-list"></i>&nbsp;<?= __("Lista de Aves de Albacete") ?></a></li>
							<li class="divider"></li>
							<!-- Fotos por expecie -->
							<li><a href="/especie/fotos/"><i
										class="icon-picture"></i>&nbsp;<?= __("Fotos por Especie") ?></a></li>
							<li class="divider"></li>
							<!-- Especies objetivo -->
							<li><a href="/especie/especies_objetivo/"><i
										class="icon-flag"></i>&nbsp;<?= __("Especies objetivo") ?></a></li>
						</ul>
					...
					<li class="<?= $localizacion ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-map-marker"></i>&nbsp;&nbsp;<?= __("Localización") ?>
							<b class="caret"></b> </a>
						<ul class="dropdown-menu">
							<!-- Lugares -->
							...
							<!-- Cuadriculas UTM -->
							<li><a href="/cuadriculaUtm/"><i class="icon-globe"></i>&nbsp;<?= __("Cuadrículas UTM") ?>
								</a></li>
						</ul>
					...
					<li class="<?= $observadores ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><i
								class="icon-user"></i>&nbsp;&nbsp;<?= __("Observadores") ?> <b class="caret"></b> </a>
						<ul class="dropdown-menu">
							<!-- Observadores -->
							<li><a href="/observadorPrincipal/"><i class="icon-user"></i>&nbsp;<?= __("Observadores") ?>
								</a></li>
							<li class="divider"></li>
							<!-- Colaboradores -->
							<li><a href="/observadorSecundario/"><i
										class="icon-user"></i>&nbsp;<?= __("Colaboradores") ?></a></li>
						</ul>
					<li class="divider-vertical"></li>

					<!-- Acerca de -->
					<li class="<?= $acercaDe ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-info-sign"></i>&nbsp;&nbsp;<?= __("Acerca de") ?>
							<b class="caret"></b> </a>
						<ul class="dropdown-menu">
							<!-- El anuario -->
							...
							<li class="divider"></li>
							<!-- Contacto -->
							<li><a href="/pages/contacto/"><i class="icon-envelope"></i>&nbsp;<?= __("Contacto") ?></a>
							</li>
						</ul>
					<li class="divider-vertical"></li>
